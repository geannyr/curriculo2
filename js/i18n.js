  ...
  const translations = {
    pt: {
      ...
      projects: {
        ...
        p1: { title: 'Buscador de Perfil GitHub', desc: 'Aplicação web para buscar e exibir perfis do GitHub de forma interativa.' },
    ...
    en: {
      ...
      projects: {
        ...
        p1: { title: 'GitHub Profile Finder', desc: 'Web app to search and display GitHub profiles interactively.' },
    ...
    es: {
      ...
      projects: {
        ...
        p1: { title: 'Buscador de Perfil GitHub', desc: 'Aplicación web para buscar y mostrar perfiles de GitHub de forma interactiva.' },
